...
KERNEL_MAKE_FLAGS += -j$(shell prebuilts/tools-guaiyihu/$(HOST_PREBUILT_TAG)/bin/nproc --all)
...
TOOLS_PATH_OVERRIDE := \
    PATH=$(BUILD_TOP)/prebuilts/tools-guaiyihu/$(HOST_PREBUILT_TAG)/bin:$$PATH \
    LD_LIBRARY_PATH=$(BUILD_TOP)/prebuilts/tools-guaiyihu/$(HOST_PREBUILT_TAG)/lib:$$LD_LIBRARY_PATH \
    PERL5LIB=$(BUILD_TOP)/prebuilts/tools-guaiyihu/common/perl-base
